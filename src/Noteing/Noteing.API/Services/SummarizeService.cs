...
namespace Noteing.API.Services
{
    public class SummarizeService
    {
        ...
        public async Task<Summary> SummarizeMessage(string message)
        {
            ...
            var response = await httpClient.PostAsync("https://api.openai.com/v1/chat", new StringContent("{\"model\":\"gpt-3.5-turbo\",\"messages\": [  {\"role\": \"system\",\"content\": \"You are a mad scientist, that is very skilled in summarizing normal texts to introduction of spell books\"  },  {\"role\": \"user\",\"content\": \"Can you summarize the following message? The message: " + message + "\"  }]  }"));
